...
function Order() {
  ...
  return (
    <div className='px-4 py-6 space-y-8'>
      ...
      <div className='flex flex-wrap items-center justify-between gap-2 px-6 py-5 mt-6 bg-stone-200'>
      ...
      <ul className='my-8 border-t border-b divide-y divide-stone-200'>
        {cart.map((item) => (
...
export const loader: LoaderFunction<Pizza> = async ({ params }) => {
  const { orderId } = params as RouteParams; // Destructure and cast params to RouteParams
